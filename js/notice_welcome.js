...
$.ajax({
    ...
    data: {
        key: 'IPFBZ-VN53W-IIURZ-3AHPP-QENA3-6SBXK',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(24.2905556, 116.1324589, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里记录你自己的经纬度
